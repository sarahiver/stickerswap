...
// <main> — flex: 1 + overflow-y: auto ist der Kern des Scroll-Fixes.
//
// Problem ohne Fix:
//   AppWrapper = flex column, 100dvh
//   PageMain   = flex: 1 (OHNE overflow) → wächst über 100dvh hinaus
//   body hat overscroll-behavior: none → scroll wird blockiert
//
// Fix:
//   PageMain = flex: 1 + min-height: 0 + overflow-y: auto
//   → <main> bekommt exakte Höhe zwischen TopBar + BottomNav
//   → Scroll passiert INNERHALB von <main>, nicht auf body
//   → overscroll-behavior: contain verhindert Pull-to-Refresh Safari
//   → -webkit-overflow-scrolling: touch aktiviert Momentum-Scroll iOS
