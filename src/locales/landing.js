...
const landing = {
  ...
  /* ── ARABIC ── */
  ar: {
    nav:{ login:'تسجيل الدخول', start:'ابدأ مجاناً' },
    hero:{
      eyebrow:'🏆 لعشاق ألبومات بانيني كأس العالم 2026',
      line1:'تبادل.',
      line2:'اجمع.\nاربح.',
      sub:'أول منصة لتبادل ملصقات بانيني مع مستخدمين موثقين وحماية من الاحتيال وأكثر من 1000 ملصق لكل ألبوم.',
      cta:'سجّل الآن مجاناً',
      demo:'شاهد العرض التجريبي →',
    },
    stats:{ users:'هواة نشطون', swaps:'تبادلات ناجحة', satisfaction:'رضا المستخدمين', albums:'ألبومات نشطة' },
    features:{
      title:'لماذا StickerSwap؟',
      sub:'لأن مجموعات فيسبوك كانت موضة عام 2006.',
      items:[
        {icon:'🔐',title:'مستخدمون موثقون 100%',    desc:'لا ملفات مجهولة الهوية. كل مستخدم يتم التحقق منه عبر البريد الإلكتروني مع نظام سمعة وسجل تبادلات.'},
        {icon:'🎯',title:'مطابقة ذكية',              desc:'خوارزميتنا تجد تلقائياً شركاء التبادل الذين لديهم ما تحتاجه — ويحتاجون ما لديك.'},
        {icon:'📱',title:'المسح عبر التطبيق',        desc:'امسح الملصقات بالكاميرا أو أدخل الرقم يدوياً. يتحدث ألبومك تلقائياً.'},
        {icon:'🌍',title:'متعدد اللغات',              desc:'الألمانية والإنجليزية والفرنسية والإسبانية و11 لغة أخرى — تبادل مع هواة من جميع أنحاء أوروبا.'},
        {icon:'🛡️',title:'حماية من الاحتيال',       desc:'نظام تقييم وقفل التبادلات وإخفاء هوية العناوين وشرط رمز التتبع الاختياري.'},
        {icon:'⚡',title:'سوق مباشر',                desc:'عروض التبادل في الوقت الفعلي — فلتر حسب المنطقة والشحن ونوع الألبوم والتقييم.'},
      ],
    },
    trust:{
      title:'الأمان أولاً',
      sub:'نحمي مجتمعنا بنشاط من الاحتيال.',
      items:[
        {icon:'🔒',title:'إخفاء هوية العنوان',       desc:'تبقى العناوين الحقيقية مخفية حتى تأكيد الطرفين.'},
        {icon:'⭐',title:'نظام السمعة',               desc:'كل تبادل يمنحك نقاطاً. التقييمات السيئة تؤثر فوراً على الظهور.'},
        {icon:'🚨',title:'نظام الإبلاغ',              desc:'أبلغ عن الاحتيال أو الغياب — نحقق خلال 24 ساعة ونحظر عند الإساءة.'},
        {icon:'📦',title:'رمز التتبع (Pro)',           desc:'يمكن للمستخدمين المميزين اشتراط التتبع — حتى يعرف الجميع أين طردهم.'},
        {icon:'🤝',title:'تأكيد متبادل',              desc:'لا يكتمل التبادل إلا عندما يؤكد الطرفان الاستلام.'},
        {icon:'🏷️',title:'شارة الملف الموثق',        desc:'فضّل التبادل مع المستخدمين الموثقين — يُعرَفون بعلامة الصح الخضراء.'},
      ],
    },
    pricing:{
      title:'الباقات والأسعار',
      sub:'الجمع مجاني — ادفع بعدالة مقابل المزيد.',
      popular:'الأكثر شعبية',
      plans:[
        {name:'مجاني',price:'0€',per:'/ شهر',desc:'للهواة العاديين. جميع الميزات الأساسية مضمّنة.',features:['ألبوم نشط واحد','10 تبادلات / شهر','مطابقة أساسية','ملف عام'],disabled:['أولوية المطابقة','الحزم الذكية'],cta:'ابدأ مجاناً'},
        {name:'Pro',price:'2.99€',per:'/ شهر',desc:'للهواة الجادين. أنهِ ألبومك أسرع بميزات ذكية.',features:['ألبومات غير محدودة','تبادلات غير محدودة','أولوية المطابقة','الحزم الذكية (5، 10)','اشتراط رمز التتبع','تجربة خالية من الإعلانات'],disabled:[],cta:'جرّب Pro',featured:true},
        {name:'تاجر',price:'9.99€',per:'/ شهر',desc:'للمتاجر التي تشتري أو تبيع الملصقات المكررة.',features:['وظيفة البيع (سعر ثابت)','صفحة متجر مخصصة','استيراد مجمّع CSV','تحليلات وتقرير الإيرادات','شارة التاجر الموثق','عمولة 5% لكل بيع'],disabled:[],cta:'ابدأ كتاجر'},
      ],
      revenue:{
        title:'نماذج الإيرادات',
        items:[
          {icon:'💳',title:'الاشتراكات',              desc:'مجاني → Pro → تاجر. إيرادات متكررة قابلة للتوسع.'},
          {icon:'🏪',title:'عمولة 5% من السوق',       desc:'على كل عملية بيع ملصقات (لا التبادلات) نأخذ 5%.'},
          {icon:'🎯',title:'شراكة بانيني',             desc:'روابط تابعة لمجموعات البداية الرسمية والحزم العمياء وألبومات الجمع.'},
          {icon:'📊',title:'بيانات المجتمع (مجهولة)', desc:'ترخيص رؤى الملصقات المفقودة للناشرين وتجار التجزئة.'},
        ],
      },
    },
    concept:{
      title:'المفهوم والتقنية',
      sub:'ما يعمل خلف الكواليس — وإلى أين يتجه.',
      cards:[
        {icon:'🏗️',title:'التقنيات المستخدمة',      items:['واجهة أمامية React / CRA (Vercel)','خلفية Supabase (Auth, DB, Edge Functions)','Stripe للاشتراكات والمدفوعات','Brevo SMTP للبريد الإلكتروني والإشعارات','i18next لـ 15 لغة','Claude API للمطابقة الذكية وكشف الاحتيال','Cloudinary للصور والمسح']},
        {icon:'📅',title:'خريطة الطريق',            items:['المرحلة 1: MVP — المنصة، الملف الشخصي، المطابقة','المرحلة 2: تطبيق جوال (React Native)، مسح الباركود','المرحلة 3: وحدة التاجر، وظيفة البيع','المرحلة 4: تحفيز (إنجازات، قوائم صدارة)','المرحلة 5: تقييم AI للملصقات النادرة','المرحلة 6: التوسع إلى بوكيمون وغيره']},
        {icon:'🎯',title:'الجمهور المستهدف',         items:['6–16 مليون هاوٍ نشط لبانيني في أوروبا','كأس العالم/أوروبا: قفزات نمو 5–10 أضعاف','الأطفال (بحساب الوالدين)، المراهقون، البالغون','الهواة العاديون والمهووسون بالاكتمال','الأندية والمدارس والجمعيات كحسابات جماعية']},
        {icon:'🔑',title:'نقاط التميز',              items:['مطابقة ذكية بدلاً من البحث اليدوي','حماية كاملة من الاحتيال (وكيل العنوان، التقييم)','أكثر من 1000 ملصق لكل ألبوم منظم جيداً','متعدد اللغات منذ اليوم الأول (15 لغة)','لا مستخدمين مجهولين — مجتمع فقط','جودة تصميم على مستوى تطبيقات الشركات التقنية']},
      ],
    },
    cta:{
      line1:'ألبومك.',
      line2:'ينتظرك.',
      sub:'سجّل مجاناً. ابدأ فوراً.',
      btn:'🚀 ابدأ مجاناً الآن',
      fine:'لا اشتراك. لا بطاقة. مجاني للأبد.',
    },
    footer:{copy:'© 2026 StickerSwap · متوافق مع GDPR · هامبورغ',impressum:'إشعار قانوني',privacy:'الخصوصية',terms:'الشروط'},
  },
